...
<section id="principal">
    ...
    <section id="menu_esquerdo">
        <nav id="lateral"> <br /> 
            ...
            <form action="login.php" name="login" method="post" id="formulario">
                    ...
                    E-mail: &nbsp; <input type="text" name="usuario" autofocus="autofocus" required="required" size="15"/>
                    <br /><br />
    ...
    <section id="conteudo">
                ...
                <iframe src="listarCarrinho.php" name="quadro" frameborder="" id="frame"></iframe>	
